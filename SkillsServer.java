...
public class SkillsServer {
	...
	class ServerThread implements Runnable {
		...
		void update() throws FileNotFoundException {
			Fridge.configureFromFile("C:\\Users\\mOh\\Documents\\IdeaProjects\\Home-Smart-Appliances\\src\\Fridge.txt");
			Oven.configureFromFile("C:\\Users\\mOh\\Documents\\IdeaProjects\\Home-Smart-Appliances\\src\\Oven.txt");
			Gas.configureFromFile("C:\\Users\\mOh\\Documents\\IdeaProjects\\Home-Smart-Appliances\\src\\Gas.txt");
		}
		...
		public void run() {
			try {
				...
				FileWriter fileStream = new FileWriter(new File(
						"C:\\Users\\mOh\\Documents\\IdeaProjects\\Home-Smart-Appliances\\src\\StoreCustomers.txt"),true);
